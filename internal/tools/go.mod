module github.com/gardener/opentelemetry-collector/internal/tools
...
require (
	...
	go.opentelemetry.io/collector/cmd/builder v0.117.0 // indirect
	go.opentelemetry.io/collector/cmd/mdatagen v0.117.0 // indirect
